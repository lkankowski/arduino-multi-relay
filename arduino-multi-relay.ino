...
// Row params: sensor ID - sensor ID for Domoticz/Home Assistant
...
//             relay description - visible in Domoticz/Home Assistant, helps initial configuration
...
void setup() {
  ...
  delay(5000);
  // Send state to Domoticz/Home Assistant
  for(int i = 0; i < numberOfRelayButtons; i++) {
